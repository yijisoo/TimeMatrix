 ...
 * OverviewCanvas.java
 * 
 * Created            by Rowan Christmas
 * Adopted 2009-03-17 by Ji Soo Yi <yij@purdue.edu>.
 * ------------------------------------------------------------------
 */
 ...
 */
public class OverviewCanvas extends PCanvas implements PropertyChangeListener {
	...
	/**
	 * Creates a new instance of a OverviewCanvas
	 */
	 ...
	 * OverviewCanvaser This can be called from outside code
	 */
